...
CURVE_INNER = 2.0          # velocidad de la rueda interior en giros (rad/s)
ACTION_STEPS_FWD = 10      # nº de ticks que dura A_FORWARD
...
#Se usan los 3 sensores que miran hacia adelante:
...
OBSTACLE_THR_CENTER = 150  
OBSTACLE_THR_SIDE = 550    
AVOID_TURN_SPEED = 14.0    
